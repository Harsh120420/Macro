...
//
    ...
    function import(Request $request)
    {
        ...
        if (strlen($next_column_after_highest) > 1) {   // if you go beyond z or Z reset to a or A
    ...
    function report_paginate()
    {
        ...
        if ($search_key) {
            $query->having('name', 'like', like_search_wildcard_gen($search_key))//->orhaving('total_invoices', 'like', like_search_wildcard_gen($search_key))
            ;
