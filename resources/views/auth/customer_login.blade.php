...
<div class="container" style="padding-top: 5%;">
   <div class="row">
      ...
      <div class="col-md-4 offset-md-4" style="background-color: #fff;">
         <div style="padding: 20px;">
            <form method="POST" action="{{ route('customer_login_page') }}">
               {{ csrf_field() }}
               ...
               <div class="form-group">
                  <button style="cursor: pointer;" class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button>
                  <a class="btn btn-link" href="{{ route('customer_password_request') }}">
